<!-- omit in toc -->
# Contributing to GraphRAG Pattern Catalog
...
[GraphRAG Pattern Catalog Code of Conduct](https://github.com/graphrag/graphrag.github.ioblob/master/CODE_OF_CONDUCT.md).
...
- Open an [Issue](https://github.com/graphrag/graphrag.github.io/issues/new).
...
- Open an [Issue](https://github.com/graphrag/graphrag.github.io/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/graphrag/graphrag.github.io/issues).
...
- **Explain why this enhancement would be useful** to most GraphRAG Pattern Catalog users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
